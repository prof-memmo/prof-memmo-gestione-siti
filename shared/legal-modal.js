...
(function () {
  ...
  function buildContattiHTML(sostieniUrl) {
    return '<div class="pm-discover-box" style="display:flex; align-items:center; gap:14px;"><i class="fa-solid fa-box-open" style="font-size:1.8rem; color:#2563eb; flex-shrink:0;"></i><div><a href="https://prof-memmo.github.io/games/" target="_blank" style="font-weight:600; text-decoration:underline;">Scopri i materiali, i giochi e la filosofia</a> e <a href="https://prof-memmo.github.io/games/condividi-esperienza.html" target="_blank" style="font-weight:600; text-decoration:underline;">condividi la tua esperienza!</a></div></div>' +
